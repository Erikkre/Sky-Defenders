...
//import com.kredatus.skydefenders.GameObjects.Boost;
...
public class GameRenderer {
    ...
    public GameRenderer(GameWorld world,LightHandler lightHandler, TinyBirdHandler tinyBirdHandler, BirdHandler birdHandler, BgHandler bgHandler, TargetHandler targetHandler, UiHandler uiHandler, Airship airship, int camWidth, int camHeight) {
        ...
        cam=(OrthographicCamera)((SkyDefendersMain)Gdx.app.getApplicationListener()).loader.stage.getCamera();
...
public void setRotate(float angle){
    ...
    private void initAssets() {
        ...
        reticle=((SkyDefendersMain) Gdx.app.getApplicationListener()).loader.tA.findRegion("reticle");
        ...
        flashShader = ((SkyDefendersMain) Gdx.app.getApplicationListener()).loader.manager.get(((SkyDefendersMain) Gdx.app.getApplicationListener()).loader.assets.flashShader);
    }
