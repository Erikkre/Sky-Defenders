...
public class LightHandler { //consider making barlight and mirroring on each side of city
    ...
    public  void newBgLighting(int bgNumber) {
        ...
        if (bgNumber < 9) {         //phoenix
            ...
            Collections.addAll(bgLights, newConeLightMirrored(foreRayHandler,  255, 237, 137, sA, lDia, cityC2,90,90));       //cone
            ...
            Collections.addAll(bgLights, newConeLightMirrored(foreRayHandler,  255, 170, 140, sA, lDia, cityC2,90,90));       //cone));       //cone
            ...
            Collections.addAll(bgLights, newConeLightMirrored(foreRayHandler,  43, 158, 238, sA, lDia, cityC2,90,90));       //cone));       //cone
            ...
            Collections.addAll(bgLights, newConeLightMirrored(foreRayHandler,  227, 133, 37, sA, lDia, cityC2,90,90));       //cone));       //cone
            ...
            Collections.addAll(bgLights, newConeLightMirrored(foreRayHandler,  94, 252, 177, sA, lDia, cityC2,90,90));       //cone));       //cone
            ...
            Collections.addAll(bgLights, newConeLightMirrored(foreRayHandler,  220, 221, 226, sA, lDia, cityC2,90,90));       //cone));       //cone
            ...
            Collections.addAll(bgLights, newConeLightMirrored(foreRayHandler,  230, 49, 252, sA, lDia, cityC2,90,90));       //cone));       //cone
            ...
            Collections.addAll(bgLights, newConeLightMirrored(foreRayHandler,  255, 255, 67, sA, lDia, cityC2,90,90));       //cone));       //cone
