package com.kredatus.skydefenders.NonGameHandlerScreens;
...
import com.kredatus.skydefenders.TweenAccessors.SpriteAccessor;
...
public class SplashScreen implements Screen {
    ...
    private SkyDefendersMain game;
    public static final int width= 1;
    public SplashScreen(SkyDefendersMain game) {
        this.game = game;
    }
    ...
    public void show() {
        ...
        sprite = new Sprite(((SkyDefendersMain) Gdx.app.getApplicationListener()).loader.tA.findRegion("logo"));
