        ...
        endSecondMovementY=new TweenCallback() {
            ...
            public void onEvent(int i, BaseTween<?> baseTween) {
                ...
                if (type=='g') {
                    ...
                    ((FlockBlockersMain) Gdx.app.getApplicationListener()).loader.gameHandler.uiHandler.fadeAwayNumberEffect(UiHandler.expBar.localToStageCoordinates(new Vector2(
                    ...
                    ((FlockBlockersMain) Gdx.app.getApplicationListener()).loader.gameHandler.uiHandler.fadeAwayNumberEffect(UiHandler.fuelSymbol.localToStageCoordinates(new Vector2(
                    ...
                    ((FlockBlockersMain) Gdx.app.getApplicationListener()).loader.gameHandler.uiHandler.fadeAwayNumberEffect(UiHandler.ammoSymbol.localToStageCoordinates(new Vector2(
                    ...
                    ((FlockBlockersMain) Gdx.app.getApplicationListener()).loader.gameHandler.uiHandler.fadeAwayNumberEffect(UiHandler.airshipHealthBar.localToStageCoordinates(new Vector2(
